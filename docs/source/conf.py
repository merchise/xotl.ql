# -*- coding: utf-8 -*-
#
# xotl.ql documentation build configuration file, created by
...
__dist = pkg_resources.get_distribution('xotl.ql')
version = __dist.parsed_version.base_version
# The full version, including alpha/beta/rc tags.
release = __dist.version
del __dist
...
latex_documents = [
  ('index', 'xotlql.tex', u'xotl.ql Documentation',
...
man_pages = [
    ('index', 'xotlql', u'xotl.ql Documentation',
...
texinfo_documents = [
  ('index', 'xotlql', u'xotl.ql Documentation',
   u'Merchise Autrement', 'xotlql', 'One line description of project.',
   'Miscellaneous'),
]
